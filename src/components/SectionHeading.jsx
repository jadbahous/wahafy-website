...
export default function SectionHeading({ eyebrow, heading, sub, cta, align = 'left', max = '46ch', className = '' }) {
  ...
  return (
    ...
    >
      ...
      <h2 className="font-display font-semibold text-[clamp(2.2rem,5vw,3.6rem)] leading-[1.02] tracking-[-0.035em] text-white">
        {heading}
      </h2>
      {sub && <p className="mt-5 text-[16px] leading-relaxed text-white/55">{sub}</p>}
      {cta && (
        <Link
          to={cta.href}
