...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink text-white/50 py-8 border-t border-white/10">
      <div className="section-wrap flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px] uppercase tracking-[0.14em]">
        ...
        <span className="normal-case tracking-normal text-white/45">{footer.tagline}</span>
